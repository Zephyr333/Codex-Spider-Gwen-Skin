...
html.codex-spider-gwen-immersive aside.app-shell-left-panel button:hover {
  ...
  box-shadow:
    -3px 3px 20px rgb(89 215 240 / .08),
    3px -3px 18px rgb(255 92 168 / .10) !important;
...
html.codex-spider-gwen-immersive .dream-home .group\/home-suggestions button:hover {
  ...
  background:
    radial-gradient(circle at 88% 10%, rgb(255 92 168 / .18), transparent 30%),
    linear-gradient(145deg, rgb(8 30 54 / .86), rgb(20 18 56 / .80)) !important;
  box-shadow:
    -5px 5px 24px rgb(89 215 240 / .12),
    5px -5px 24px rgb(255 92 168 / .14),
