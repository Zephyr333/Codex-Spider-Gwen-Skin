...
html.codex-spider-gwen-immersive aside.app-shell-left-panel button:hover {
  ...
  background:
    linear-gradient(100deg, rgb(89 215 240 / .15), rgb(120 71 232 / .13) 56%, rgb(255 92 168 / .14)) !important;
  box-shadow:
    inset 2px -1px 0 var(--sg-edge-cyan-strong),
    inset -2px 1px 0 var(--sg-edge-pink-strong) !important;
...
html.codex-spider-gwen-immersive aside.app-shell-left-panel [aria-current="page"] {
  ...
  border: 1px solid rgb(89 215 240 / .34) !important;
  border-radius: 7px 17px 7px 17px !important;
  box-shadow:
    inset -2px 1px 0 var(--sg-edge-pink-strong),
    2px -2px 0 rgb(255 92 168 / .20),
    -2px 2px 0 rgb(89 215 240 / .16),
...
html.codex-spider-gwen-immersive .dream-home [data-feature="game-source"] button {
  ...
  border: 1px solid rgb(89 215 240 / .48) !important;
...
html.codex-spider-gwen-immersive .dream-home .group\/home-suggestions button {
  ...
  box-shadow:
    inset 1px -1px 0 var(--sg-edge-cyan),
    inset -1px 1px 0 var(--sg-edge-pink),
    2px -2px 0 rgb(255 92 168 / .13),
    -2px 2px 0 rgb(89 215 240 / .11),
    0 12px 28px var(--sg-shadow) !important;
...
html.codex-spider-gwen-immersive .dream-home .group\/home-suggestions button:hover {
  border-color: rgb(89 215 240 / .60) !important;
  box-shadow:
    inset 1px -1px 0 var(--sg-edge-cyan-strong),
    inset -1px 1px 0 var(--sg-edge-pink-strong),
    3px -3px 0 rgb(255 92 168 / .22),
    -3px 3px 0 rgb(89 215 240 / .19),
    0 16px 32px var(--sg-shadow) !important;
...
html.codex-dream-skin.dream-art-wide.codex-spider-gwen-immersive .dream-home-utility {
  ...
  background: var(--sg-surface-soft) !important;
  box-shadow:
    inset 1px 0 var(--sg-edge-cyan-soft),
    inset -1px 1px 0 var(--sg-edge-pink-soft) !important;
...
html.codex-dream-skin.dream-art-wide.codex-spider-gwen-immersive .composer-surface-chrome {
  color: var(--sg-paper) !important;
  border: 1px solid rgb(89 215 240 / .26) !important;
  border-radius: 18px !important;
  background: var(--sg-surface) !important;
  box-shadow:
    0 14px 32px var(--sg-shadow),
    inset 1px -1px 0 var(--sg-edge-cyan),
    inset -1px 1px 0 var(--sg-edge-pink) !important;
  backdrop-filter: blur(14px) saturate(1.04) !important;
...
html.codex-dream-skin.dream-art-wide.codex-spider-gwen-immersive .dream-home:has(.dream-home-utility) .composer-surface-chrome {
  ...
  box-shadow:
    0 14px 32px var(--sg-shadow),
    inset 1px -1px 0 var(--sg-edge-cyan),
    inset -1px 0 var(--sg-edge-pink) !important;
  overflow: hidden !important;
}
...
html.codex-spider-gwen-immersive [role="combobox"] {
  color: var(--sg-paper) !important;
  border-color: rgb(89 215 240 / .24) !important;
...
html.codex-spider-gwen-immersive main.main-surface [data-message-author-role="user"] {
  color: var(--sg-paper) !important;
  border: 1px solid rgb(255 92 168 / .26) !important;
  border-radius: 7px 17px 7px 17px !important;
  background: var(--sg-surface-soft) !important;
  box-shadow:
    inset 1px -1px 0 var(--sg-edge-cyan-soft),
    inset -1px 1px 0 var(--sg-edge-pink-soft),
    -2px 2px 0 rgb(89 215 240 / .08),
    2px -2px 0 rgb(255 92 168 / .10) !important;
}
...
html.codex-spider-gwen-immersive main.main-surface [class*="code-block"] {
  ...
  border: 1px solid rgb(89 215 240 / .24) !important;
  border-radius: 6px 15px 6px 15px !important;
  background: var(--sg-surface-strong) !important;
  box-shadow:
    inset 2px -1px 0 var(--sg-edge-cyan),
    inset -1px 1px 0 var(--sg-edge-pink-soft),
...
html.codex-spider-gwen-immersive [data-radix-popper-content-wrapper] > div {
  color: var(--sg-paper) !important;
  border: 1px solid rgb(89 215 240 / .30) !important;
  border-radius: 8px 18px 8px 18px !important;
  background: var(--sg-surface-strong) !important;
  box-shadow:
    inset 1px -1px 0 var(--sg-edge-cyan),
    inset -1px 1px 0 var(--sg-edge-pink),
    -2px 2px 0 rgb(89 215 240 / .08),
    3px -3px 0 rgb(255 92 168 / .13),
    0 22px 52px rgb(1 6 18 / .62) !important;
...
html.codex-spider-gwen-immersive main.main-surface [class~="bg-token-dropdown-background/50"] {
  box-shadow:
    inset 1px -1px 0 var(--sg-edge-cyan-soft),
    inset -1px 1px 0 var(--sg-edge-pink-soft),
    0 12px 28px rgb(1 7 18 / .22) !important;
}

html.codex-spider-gwen-immersive :focus-visible {
  outline: 2px solid var(--sg-cyan) !important;
  outline-offset: 2px !important;
  box-shadow:
    -2px 2px 0 var(--sg-cyan),
    2px -2px 0 var(--sg-pink) !important;
}
...
#codex-spider-gwen-immersive-chrome.spider-gwen-task-shell .sg-print-dots,
#codex-spider-gwen-immersive-chrome.spider-gwen-task-shell .sg-speed-lines,
#codex-spider-gwen-immersive-chrome.spider-gwen-task-shell .sg-web-corner {
  opacity: .055;
}
